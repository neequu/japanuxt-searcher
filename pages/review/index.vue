...
<template>
  ...
  <section v-else class="mt-8 h-full flex flex-1 flex-col items-center md:place-content-center md:gap-10">
    ...
    <button v-if="newWords.length" class="group mx-auto inline-flex border border-accent rounded-xl px-5 py-2 text-accent outline-none transition-300 md:mx-0 md:mt-0 md:px-10 md:py-4 md:text-3xl hover:shadow-accent" @click="reviewSession = true">
    ...
    <div v-else class="grid mt-4 place-items-center gap-4">
      ...
      <div class="flex gap-4">
        <NuxtLink class="group mx-auto inline-flex border border-accent rounded-xl px-5 py-2 text-accent outline-none transition-300 md:mx-0 md:mt-0 md:px-10 md:py-4 md:text-3xl hover:shadow-accent" to="/decks">
          <span class="border-b border-transparent text-center group-focus-visible:border-blueGray">
            JLPT Decks
          </span>
        </NuxtLink>
        <NuxtLink class="group mx-auto inline-flex border border-accent rounded-xl px-5 py-2 text-accent outline-none transition-300 md:mx-0 md:mt-0 md:px-10 md:py-4 md:text-3xl hover:shadow-accent" to="/">
          <span class="border-b border-transparent text-center group-focus-visible:border-blueGray">
            Go Home
          </span>
        </NuxtLink>
